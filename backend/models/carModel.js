...
const carSchema = new Schema({
  ...
  bookings: { type: [carBookingSubSchema], default: [] },//shows id
});
function rangesOverlap(aStart,aEnd,bStart,bEnd){
    return aStart<= bEnd&& bStart <=aEnd;
}
carSchema.method.isAvailableForRange=function(
...
//filter for booking should block aavailabiluty
...
//car willbe blocked if its booked
...
//it will find the nex booking date
