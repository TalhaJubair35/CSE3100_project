...
const carSummarySchema = new Schema(
    {
        id: { type: Schema.Types.ObjectId, ref: "Car", required: true },//coming from car
...
const bookingSchema = new Schema(
    {
        userId: { type: Schema.Types.ObjectId, ref: "User", required: true },//coming from usermodel
    ...
    { timestamps: true }
);//customer details and shiping and payment
...
export default mongoose.models.Bookings||mongoose.model('Booking',bookingSchema)
