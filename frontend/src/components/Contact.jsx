...
import { FaCalendar, FaCalendarAlt, FaCar, FaClock, FaComment, FaEnvelope, FaInfo, FaPhone, FaRocket, FaUser, FaWhatsapp } from 'react-icons/fa'
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        window.open(`https://wa.me/+8801709128396?text=${whatsappMessage}`, '_blank');
            ...
            <div className={styles.content}>
                <div className={styles.titleContainer}>
                    ...
                    <p className={styles.subtitle}>
                        Have questions about our premium fleet? our team is ready to assist with your car
                    </p>
                </div>
                ...
                <div className={styles.cardContainer}>
                    <div className={styles.infoCard}>
                        ...
                        <div className='relative z-10 space-y-5'>
                            <h2 className={styles.infoTitle}> Our Information</h2>
                            <div className={styles.infoItemContainer}>
                                {
                                    [
                                        { icon: FaWhatsapp, label: 'WhatsApp', value: '+880 1709128396', color: 'bg-green-900/30' },
                                        ...
                                        <div key={i} className={styles.infoItem}>
                                            ...
                                            <div>
                                                <h3 className={styles.infoLabel}></h3>
                            ...
                            <div className={styles.offerContainer}>
                                <div className='flex items-center'>
                                    <FaCalendarAlt className={styles.offerIcon}></FaCalendarAlt>
                                    <span className={styles.offerTitle}></span>
                                </div>
                                <p className={styles.offerText}>Book 3+ days for 10% Discount</p>
                    ...
                    <div className={styles.formCard}>
                        ...
                        <div className='mb-4 '>
                            <h2 className={styles.formTitle}>
                                <FaRocket className={styles.infoIcon}></FaRocket> Send you Inquiry
                            </h2>
                        ...
                        <form onSubmit={handleSubmit} className={styles.form}>
                                ...
                                {['name', 'email', 'phone', 'carType'].map((field) => {
                                    ...
                                    return (
                                        <div key={field} className={styles.inputContainer}>
                                            ...
                                            {
                                                field !== 'carType' ? (<input type={field === 'email' ? 'email' : field === 'phone' ? 'tel' : 'text'}
                                                    name={field}
                                                    value={formData[field]}
                                                    onChange={handleChange}
                                                    onFocus={() => handleFocus(field)} onBlur={handleBlur}
                                                    required
                                                    ...
                                                    <select name='carType' value={formData.carType} onChange={handleChange}
                                                        ...
                                                        <option value="">Select Car Type </option>
                                                        {
                                                            ['Economy', 'SUV', 'Luxury', 'Van', 'Sports Car', 'Convertible'].map((opt) => (
                                                                <option value={opt} key={opt} className='bg-gray-800 cursor-pointer'>{opt}</option>
                                                            ))
                                                        }
                                                    </select>
                            ...
                            <div className='relative'>
                                ...
                                <textarea name="message" value={formData.message} onChange={handleChange} onFocus={()=>handleFocus('message')} onBlur={handleBlur} required rows='3' placeholder='tell us about your rental needs...' className={styles.textarea(activeField==='message')}></textarea>
                            </div>
                            <button type='submit' className={styles.submitButton}>
                                Send Message
                                <FaWhatsapp className={styles.whatsappIcon}></FaWhatsapp>
                            </button>
                        </form>
                    </div>
