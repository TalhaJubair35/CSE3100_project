    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.headerContainer}>
                ...
                <p className={styles.subtitle}>Discover premium vehicals with execptional performance</p>
            </div>
                ...
                {visibleCars.map((car, idx) => {
                    ...
                    return (
                        <div
                            ...
                            className={`${styles.card} ${patternStyle} border ${borderStyle} ${animateCards ? 'opacity-100' : 'opacity-0 translate-y-10'} hover:shadow-2xl hover:-translate-y-3`}
                            style={{
                            ...
                            <div className={styles.content}>
                                <div className='flex justify-between items-start mb-3'>
                                    <div>
                                        ...
                                        <p className={styles.carInfoContainer}>{car.type}</p>
                                ...
                                <div className={styles.specsGrid}>
                                    {[
                                        { icon: "👤", value: car.seats, label: 'Seats' },
                                        { icon: "⛽", value: car.fuel, label: 'Fuel' },
                                        { icon: "📊", value: car.mileage, label: 'Mileage' },
                                        { icon: "⚙️", value: car.transmission, label: 'Trans' },
                                    ].map((spec, i) => (
                                        <div key={i} className={styles.specItem}>
                                            <div className={styles.specIconContainer(hoveredCard === car.id)}>
                                                <spec.icon className={styles.specIcon(hoveredCard === car.id)}></spec.icon>
                                            </div>
                                ...
                                >
                                    <span className={styles.buttonText}>
                                        ...
                                        Book now
                                        <FaArrowRight className='ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform'></FaArrowRight>
                                    </span>
                                </button>
