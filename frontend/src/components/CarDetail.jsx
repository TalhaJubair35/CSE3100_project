...
import { FaArrowLeft, FaCalendar, FaCheckCircle, FaCreditCard, FaEnvelope, FaGasPump, FaMapMarkedAlt, FaPhone, FaTachometerAlt, FaUser, FaUserFriends } from 'react-icons/fa';
const CarDetail = () => {
    ...
    <div className={carDetailStyles.pageContainer}>
      ...
      <div className={carDetailStyles.contentContainer}>
        ...
        <button onClick={() => navigate(-1)}
          ...
          <FaArrowLeft className={carDetailStyles.backButtonIcon}></FaArrowLeft>
        </button>
        <div className={carDetailStyles.mainLayout}>
          <div className={carDetailStyles.leftColumn}>
            <div className={carDetailStyles.imageCarousel}>
              <img src={carImages[currentImage]} alt={car.name}
            ...
            <div className={carDetailStyles.aboutSection}>
              <h2 className={carDetailStyles.aboutTitle}>About the Car</h2>
              <p className={carDetailStyles.aboutText}>
                Experience luxury on the {car.name}. With its {car.seats}, every journey is exceptional.
              </p>
              <p className={carDetailStyles.aboutText}>
                {
                  car.description || "This car combines performance and confort for an unforgettable drive"
                }
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className={carDetailStyles.form}>
                <div className={carDetailStyles.grid2}>
                  <div className='flex flex-col'>
                    <label htmlFor="pickupDate" className={carDetailStyles.formLabel}>
                      Pickup Date
                    </label>
                    <div className={carDetailStyles.inputContainer(activeField === "pickupDate")}>
                      ...
                      <input type="date" id='pickupDate' name='pickupDate' min={today} onChange={handleInputChange}
                  ...
                  <div className='flex flex-col'>
                    <label htmlFor="returnDate" className={carDetailStyles.formLabel}>
                      Return Date
                    </label>
                    <div className={carDetailStyles.inputContainer(activeField === "returnDate")}>
                      ...
                      <input type="date" id='returnDate' name='returnDate' min={formData.pickupDate || today} onChange={handleInputChange}
                  ...
                  <div className='flex flex-col'>
                    ...
                    <div className={carDetailStyles.inputContainer(activeField === "pickupLocation")}>
                      ...
                      <input type="text" name='pickupLocation'
                        placeholder='Enter you location' value={formData.pickupLocation} onChange={handleInputChange}
                  ...
                  <div className='flex flex-col'>
                    ...
                    <div className={carDetailStyles.inputContainer(activeField === "name")}>
                      ...
                      <input type="text" name='name'
                        placeholder='Enter your full name' value={formData.name} onChange={handleInputChange}
                  ...
                  <div className='flex flex-col'>
                    ...
                    <div className={carDetailStyles.inputContainer(activeField === "phone")}>
                      ...
                      <input type="tel" name='phone'
                        placeholder='Enter you phone' value={formData.phone} onChange={handleInputChange}
  ...
  <FaCreditCard className='mr-2 group-hover:scale-110 transition-transform'></FaCreditCard>
